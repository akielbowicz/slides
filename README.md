...
[Conozco un grupo de objetos que resuelven problemas (PyConAr 2020)](./slides/pyconar_2020/slides.html)

[Une para todes y todes para une (Python Argentina Meetup)](./slides/pyar_pairprogramming/slides.html)

[¿Code Smells? y eso... ¿con qué se come? (Python Argentina Meetup)](./slides/pyar_codesmells/slides.html)

[Me dicen que mi código es horrible😩. ¿Por qué no le dejan el tema de la belleza a lxs teoricxs? Y, ¿me explican por qué lo dicen y cómo puedo mejorarlo? (LEC)](./slides/lec_journal_club/slides.html)
[lec_refactoring_demo](https://github.com/akielbowicz/presentations/tree/lec_refactoring_demo)

[Introducción a la Mecánica Cuántica (Papers We Love Buenos Aires)](./slides/pwl_mecanica_cuantica/slides.html)

[Property Based Testing con Hypothesis (Python Argentina Meetup)](./slides/pyar_hypotesis/slides.html) [& JPMC](./slides/jpmc_hypothesis/slides.html)

[¿Cómo funcionan los Widgets de Jupyter? (PyConAr 2019)](./slides/pyconar_2019/slides.html)
